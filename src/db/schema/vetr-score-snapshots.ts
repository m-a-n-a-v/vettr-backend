...
/**
 * VETR Score Snapshots - Daily time-series table
 * Optimized for charting and trend analysis with exactly one row per ticker per day
 */
export const vetrScoreSnapshots = pgTable('vetr_score_snapshots', {
  ...
  // Stock price snapshot for this day (nullable)
  price: doublePrecision('price'),

  // Daily Action Overlay
  ...
  // Unique constraint to enable upsert (one row per ticker per day)
